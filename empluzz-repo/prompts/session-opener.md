...
- **The repo has the dashboard source and the harness**, since 2026-08-22. `dashboard/application-command-center-1787637025-41row.html` and `dashboard/verify/`. Run `dashboard/verify/run.sh` before any dashboard change ships; 56 assertions.
